...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
    """
    Forward pass for the affine-batchn-relu
...
def affine_batchnorm_relu_backward(dout, cache):
    """
    Backward pass for the affine-batchn-relu convenience layer
    """
...
def affine_relu_dropout_forward(x, w, b, dropout_param):
    """
    Forward pass for the affine-relu-dropout

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - dropout_param: Parameters for the dropout layer
